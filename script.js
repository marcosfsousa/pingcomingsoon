...
function ValidateForm(event) {
  ...
  if (emailValue === "") {
    ...
    email.parentElement.insertBefore(warning, inputBox.children[1]);
    warning.className = "accepted";
    email.className = "input-email green-border";
    warning.textContent = "Your email is added to the subscriber list.";

    if (window.innerWidth >= 768) {
      warning.className = "accepted desktop-accepted";
    }
  }
